			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="#" id="logo">A R T I S T A N</a></h1>
								<hr />
						...
						<li><a href="#banner" class="button1 scrolly">Learn More</a></li>
					</ul>
							</footer>
						</div>
					...
					<!-- Nav -->
						<nav id="nav">
							...
							<li>
								<a href="#">Gallery</a>
								<ul>
									<li><a href="#">Panting and Drawing</a></li>
									<li><a href="#">Paper Craft</a></li>
									<li><a href="#">Mud Art</a></li>
			...
			<!-- Carousel -->
				<section class="carousel">
					<div class="reel">
						...
						<article>
						   <div align="center">
							<a href="#" class="image featured card"><img src="../major/<?php echo $data['image'];?>" alt="" id="dimg" />
							<header style="padding:5px 0 5px 0">
								<h3><?php echo $data['title'];?></h3>
							</header>
								<p><?php echo $data['art_by'];?></p>
								</a>
								</div>
						</article>
                            <?php
			...
			<!-- Main -->
				<div class="wrapper style2">
					...
					<article id="main" class="container special">
						<a href="#" class="image featured"><img src="img/pic06.jpg" alt="" /></a>
						<header>
						...
						<div class="row">
							...
							<!-- Photos -->
								<section class="4u 12u(mobile)">
									...
									<div class="row 25%">
										<div class="6u">
											<a href="#" class="image fit"><img src="img/pic10.jpg" alt="" /></a>
										</div>
										<div class="6u$">
											<a href="#" class="image fit"><img src="img/pic11.jpg" alt="" /></a>
										</div>
										<div class="6u">
											<a href="#" class="image fit"><img src="img/pic12.jpg" alt="" /></a>
										</div>
										<div class="6u$">
											<a href="#" class="image fit"><img src="img/pic13.jpg" alt="" /></a>
										</div>
										<div class="6u">
											<a href="#" class="image fit"><img src="img/pic14.jpg" alt="" /></a>
										</div>
										<div class="6u$">
											<a href="#" class="image fit"><img src="img/pic15.jpg" alt="" /></a>
										</div>
									</div>
								</section>
